...
export default function DevBadge() {
  ...
  return (
    <div
      ...
      aria-hidden="true"
      className="pointer-events-none fixed bottom-14 right-3 z-40 -rotate-2 rounded-md border border-dashed border-destructive/70 bg-destructive/10 px-2 py-0.5 font-mono text-[11px] tracking-widest text-destructive shadow-sm"
    >
      开发版 DEV
    </div>
  )
