...
import type { CloseGuardEvent, ExportPorts, RegisterCloseGuard } from '../types/ports'
...
// 富文本剪贴板桩（Markdown 视图公众号复制）：本文件不断言其调用，防缺 prop
...
const renderReady = async (exportPorts: ExportPorts): Promise<MindMapHandle> => {
  render(
    <EditorView
      mdPath="/ws/a.md"
      openInEditor={vi.fn()}
