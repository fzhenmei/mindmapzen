import { DEFAULT_CONFIG, parseGitConfig, parseLayoutKind, parsePreviewOutlinePref, parseRecentOpened, parseSettings, parseThemePref, type AppConfig, type FsAdapter } from '../types/files'
