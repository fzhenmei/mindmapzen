import { DEFAULT_CONFIG, parseGitConfig, parseLayoutKind, parsePreviewOutlinePref, parseRecentOpened, parseSettings, parseThemePref, parseTourDone, type AppConfig, type FsAdapter } from '../types/files'
