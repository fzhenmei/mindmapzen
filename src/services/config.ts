import { DEFAULT_CONFIG, parseFavorites, parseGitConfig, parseLayoutKind, parseLibrarySort, parsePanelWidth, parsePreviewOutlinePref, parseRecentOpened, parseSettings, parseThemePref, parseTourDone, type AppConfig, type FsAdapter } from '../types/files'
